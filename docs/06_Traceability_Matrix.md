...
| REQ-08 | Recall ≥ 0.90 (vehicles < 30 m) | yes | `test_validation::test_missed_object_lowers_recall`, `test_validation::test_req08_scope_only_counts_vehicles_closer_than_30m` | L1 | ⚠️ Metric only (system not measured yet) |
...
| REQ-14 | Every mandatory requirement has a test | | this matrix | Process | ❌ Not met (REQ-03, 04, 10 uncovered) |
...
- **Partially covered (L1 only):** REQ-05, REQ-06, REQ-08, REQ-09, REQ-16
- **Not covered (mandatory):** REQ-03, REQ-04, REQ-10
